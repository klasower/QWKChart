...
- (void)setupViews
{
    ...
    self.layer.shadowColor = [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:0.03].CGColor;
...
//    [self addSubview:_micButton];
    ...
    [_faceButton setImage:Image(@"表情") forState:UIControlStateNormal];
...
//    [_faceButton setImage:[UIImage tk_imageNamed:@"ToolViewEmotionHL"] forState:UIControlStateHighlighted];
    ...
    [_keyboardButton setImage:Image(@"键盘") forState:UIControlStateNormal];
...
//    [_keyboardButton setImage:[UIImage tk_imageNamed:@"ToolViewKeyboardHL"] forState:UIControlStateHighlighted];
    ...
    [_moreButton setImage:Image(@"service_icon_pic") forState:UIControlStateNormal];
...
//    [self addSubview:_recordButton];
    ...
    _inputTextView.backgroundColor = HexColor(@"#F6F6F6");
    _inputTextView.delegate = self;
    _inputTextView.textContainerInset = UIEdgeInsetsMake(10, 7.0, 0, 0);
    [_inputTextView setFont:[UIFont systemFontOfSize:14]];
    [_inputTextView.layer setMasksToBounds:YES];
    [_inputTextView.layer setCornerRadius:2.0f];
    _inputTextView.placeholder = @"立即输入";
    _inputTextView.placeholderColor = HexColor(@"#999999");
...
//    _lineView.frame = CGRectMake(0, 0, Screen_Width, TTextView_Line_Height);
    ...
    _moreButton.frame = CGRectMake(_faceButton.frame.origin.x + _faceButton.frame.size.width + TTextView_Margin, buttonOriginY, buttonSize.width, buttonSize.height);
    CGFloat beginX = _moreButton.frame.origin.x + _moreButton.frame.size.width + 15;
    CGFloat endX = Screen_Width - 15;
