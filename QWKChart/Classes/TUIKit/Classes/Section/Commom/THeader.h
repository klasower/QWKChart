...
#define TTextView_Background_Color  RGBA(255, 255, 255, 1.0)
...
//message controller
#define TMessageController_Background_Color RGBA(250, 250, 250, 1.0)
#define TMessageController_Header_Height 40

//input controller
#define TInputView_Background_Color RGBA(255, 255, 255, 1.0)
